...
if(isset($_POST['name']) && isset($_POST['card']) &&isset($_POST['email']) && isset($_POST['address']) && isset($_POST['price'])){
$name = $_POST['name'];
$card = $_POST['card'];
$email = $_POST['email'];
...
$is_insert = $db->query("INSERT INTO `buy`(`name`, `card` , `email`, `address`, `price`) VALUES ('$name', '$card' ,'$email','$address', '$price')");

if($is_insert == TRUE){
  echo "<h2>Porosia juaj eshte bere me sukses...</h2>";
  exit();
}
